...
P8.16/P8.17 又补上 cell replacement 输出侧 file-backed chunk handoff 和 source-entry
file-backed extraction first slice，但还没有 event reader chunk/window input，因此不能
写成完整 low-memory large worksheet transformer。
