...
- **Patch**：`WorkbookEditor`，面向已有 workbook 的 part-level rewrite，并支持受限的 basic classic note、writer-compatible conditional-format add 与 table metadata lifecycle；未修改和未知 part 默认保留。
