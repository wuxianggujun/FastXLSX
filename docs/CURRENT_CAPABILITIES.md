...
- tracked benchmark evidence 机制已建立；当前有 4 个 production Streaming bundle、16 个 production Patch bundle 与 1 个 OpenXLSX reference bundle，共 21 个。每个 bundle 只支持 manifest 限定的单机同数据集结论，warm-up/measured 次数以各自 run context 为准。
