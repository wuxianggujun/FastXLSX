...
// Common helpers for PackageEditor preservation comments tests.
...
bool is_package_editor_shard(std::string_view shard)
{
    return shard == "all" || shard == "preservation-comments"
        || shard == "preservation-comments-threaded"
        || shard == "preservation-comments-persons"
        || shard == "preservation-comments-ordering";
}
