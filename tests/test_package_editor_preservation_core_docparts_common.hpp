...
// Common helpers for PackageEditor preservation core docparts tests.
...
{
    return shard == "all" || shard == "preservation-core-docparts"
        || shard == "preservation-core-docparts-drawing"
        || shard == "preservation-core-docparts-shared"
        || shard == "preservation-core-docparts-vba";
}
