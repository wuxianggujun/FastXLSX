...
- **Strict failure groups:** non-default or malformed source styles,
  ...
  instructions / CDATA or other unsupported markup, malformed sharedStrings structures,
