...
/// unsupported value-wrapper shapes, tolerate non-whitespace source sheetData
/// text outside rows, source row text outside cells, or source cell text outside
/// `<v>` / `<t>` / `<f>` wrappers, preserve inline rich text formatting,
/// import inline phonetic metadata, repair malformed inline rich
