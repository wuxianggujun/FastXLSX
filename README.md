...
- **Patch 下一瓶颈**：在吞吐配置 level 1 下，single-pass transform 已重新成为更大或相当的阶段；后续聚焦 parser/source-callback/action/coordinate residual。只有 size-oriented workload 在 matched level 下仍受压缩限制时，才评估其他 backend。
