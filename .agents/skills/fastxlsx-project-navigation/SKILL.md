...
- Tables、writer-compatible picture anchors 与 classic comments/notes 已有窄 read projection，但 existing-workbook table/drawing/comments semantic edit 仍未公开；charts、VBA、pivot、external links 和 custom XML 默认只可 preserve/audit/fail。不能因读取或保留测试宣称 semantic edit。
