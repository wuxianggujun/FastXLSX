...
- **Ignored metadata:** source sharedStrings and source inline rich text ignore
  ...
  ordinary PI targets using ASCII name continuation characters such as `.`,
  `-`, digits, and `:` remain ignored trivia.
