...
GENERATED_SCENARIOS = [
    ...
    "generated_in_memory_full_calc_delete_column_formula",
    "generated_in_memory_full_calc_delete_column_formula_noop_save",
    ...
    "generated_in_memory_full_calc_insert_column_formula_noop_save",
    "generated_in_memory_delete_row_formula",
    "generated_in_memory_delete_row_formula_noop_save",
    "generated_in_memory_full_calc_delete_row_formula",
    ...
    "generated_in_memory_full_calc_retry_reopen_modify_noop_save",
    ...
    "generated_image_replace_noop_save",
...
GENERATED_CASE_DIRECTORY_ALIASES = {
    ...
    "generated_in_memory_full_calc_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_save":
        "fc-ms-post-noop-reopen-noop",
    "generated_in_memory_full_calc_multi_sheet_retry_path_equivalent_reopen_modify_post_noop_reopen_modify_noop_save":
        "fc-ms-pe-post-noop-reopen-noop",
    "generated_in_memory_full_calc_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_save":
        "fc-ms-post-noop-reopen-noop-reopen",
    "generated_in_memory_full_calc_multi_sheet_retry_path_equivalent_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_save":
        "fc-ms-pe-post-noop-reopen-noop-reopen",
    "generated_in_memory_full_calc_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_noop_save":
        "fc-ms-post-noop-reopen-noop-reopen-noop",
    "generated_in_memory_full_calc_multi_sheet_retry_path_equivalent_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_noop_save":
        "fc-ms-pe-post-noop-reopen-noop-reopen-noop",
    "generated_in_memory_full_calc_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_noop_reopen_modify_save":
...
def require_generated_full_calc_metadata(
    path: Path,
...
def verify_generated_in_memory_full_calc_delete_column_formula(
    path: Path,
    tool_report: dict[str, Any] | None = None,
) -> tuple[dict[str, Any], dict[str, Any]]:
    label = "generated in-memory full-calc delete column formula"
...
def verify_generated_in_memory_full_calc_delete_column_formula_noop_save(
    path: Path,
    tool_report: dict[str, Any],
) -> tuple[dict[str, Any], dict[str, Any]]:
    label = "generated in-memory full-calc delete column formula no-op save"
    zip_report, openpyxl_report = verify_generated_in_memory_full_calc_delete_column_formula(
        path,
        tool_report,
    )
    require("save_as(noop-output)" in tool_report.get("mutations", []),
...
def verify_generated_in_memory_full_calc_insert_column_formula(
    path: Path,
    tool_report: dict[str, Any] | None = None,
) -> tuple[dict[str, Any], dict[str, Any]]:
    label = "generated in-memory full-calc insert column formula"
...
def verify_generated_in_memory_full_calc_insert_column_formula_noop_save(
    path: Path,
    tool_report: dict[str, Any],
) -> tuple[dict[str, Any], dict[str, Any]]:
    label = "generated in-memory full-calc insert column formula no-op save"
    zip_report, openpyxl_report = verify_generated_in_memory_full_calc_insert_column_formula(
        path,
        tool_report,
    )
    require("save_as(noop-output)" in tool_report.get("mutations", []),
...
def verify_generated_in_memory_full_calc_delete_row_formula(
    path: Path,
    tool_report: dict[str, Any] | None = None,
) -> tuple[dict[str, Any], dict[str, Any]]:
    label = "generated in-memory full-calc delete row formula"
...
def verify_generated_in_memory_full_calc_delete_row_formula_noop_save(
    path: Path,
    tool_report: dict[str, Any],
) -> tuple[dict[str, Any], dict[str, Any]]:
    label = "generated in-memory full-calc delete row formula no-op save"
    zip_report, openpyxl_report = verify_generated_in_memory_full_calc_delete_row_formula(
        path,
        tool_report,
    )
    require("save_as(noop-output)" in tool_report.get("mutations", []),
...
def verify_generated_in_memory_full_calc_retry_reopen_modify_noop_save(
    path: Path,
    tool_report: dict[str, Any],
) -> tuple[dict[str, Any], dict[str, Any]]:
    label = "generated in-memory full-calc retry reopen modify no-op save"
    zip_report, openpyxl_report = (
        verify_generated_in_memory_retry_reopen_modify_noop_save(
            path,
            tool_report,
        )
    )
...
def verify_generated_in_memory_full_calc_retry_path_equivalent_reopen_modify_noop_save(
    path: Path,
    tool_report: dict[str, Any],
) -> tuple[dict[str, Any], dict[str, Any]]:
    label = "generated in-memory full-calc path-equivalent retry reopen modify no-op save"
    zip_report, openpyxl_report = (
...
def verify_generated_in_memory_full_calc_retry_reopen_modify_post_noop_third_save(
    path: Path,
    tool_report: dict[str, Any],
) -> tuple[dict[str, Any], dict[str, Any]]:
    label = "generated in-memory full-calc retry reopen modify post-noop third save"
    zip_report, openpyxl_report = (
...
def verify_generated_in_memory_full_calc_retry_path_equivalent_reopen_modify_post_noop_third_save(
    path: Path,
    tool_report: dict[str, Any],
) -> tuple[dict[str, Any], dict[str, Any]]:
    label = (
        "generated in-memory full-calc path-equivalent retry reopen modify "
        "post-noop third save"
    )
    zip_report, openpyxl_report = (
...
def verify_generated_in_memory_full_calc_multi_sheet_retry_reopen_modify_noop_save(
    path: Path,
    tool_report: dict[str, Any],
) -> tuple[dict[str, Any], dict[str, Any]]:
    label = "generated in-memory full-calc multi-sheet retry reopen modify no-op save"
    zip_report, openpyxl_report = (
        verify_generated_in_memory_multi_sheet_retry_reopen_modify_noop_save(
            path,
            tool_report,
...
def verify_generated_in_memory_full_calc_multi_sheet_retry_path_equivalent_reopen_modify_noop_save(
    path: Path,
    tool_report: dict[str, Any],
) -> tuple[dict[str, Any], dict[str, Any]]:
    label = (
        "generated in-memory full-calc multi-sheet path-equivalent retry "
        "reopen modify no-op save"
    )
    zip_report, openpyxl_report = (
...
def verify_generated_in_memory_full_calc_multi_sheet_retry_reopen_modify_post_noop_third_save(
    path: Path,
    tool_report: dict[str, Any],
) -> tuple[dict[str, Any], dict[str, Any]]:
    label = (
...
def verify_generated_in_memory_full_calc_multi_sheet_retry_path_equivalent_reopen_modify_post_noop_third_save(
    path: Path,
    tool_report: dict[str, Any],
) -> tuple[dict[str, Any], dict[str, Any]]:
    label = (
        "generated in-memory full-calc multi-sheet path-equivalent retry "
        "reopen modify post-noop third save"
    )
    zip_report, openpyxl_report = (
...
def verify_generated_in_memory_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_save(
    path: Path,
    tool_report: dict[str, Any],
) -> tuple[dict[str, Any], dict[str, Any]]:
    label = (
        "generated in-memory multi-sheet retry reopen modify post-noop "
        "fresh-reopen modify no-op save"
    )
    zip_report, openpyxl_report = (
        verify_generated_in_memory_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_save(
            path,
    ...
    require("seventh:save_as(final-reopen-noop-output)" in tool_report.get("mutations", []),
            f"{label}: tool did not report the final fresh-reopen no-op save stage")
    zip_report["final_reopen_noop_save"] = "byte-identical"
    return zip_report, openpyxl_report


def verify_generated_in_memory_full_calc_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_save(
    path: Path,
    tool_report: dict[str, Any],
) -> tuple[dict[str, Any], dict[str, Any]]:
    label = (
        "generated in-memory full-calc multi-sheet retry reopen modify "
        "post-noop fresh-reopen modify no-op save"
    )
    zip_report, openpyxl_report = (
        verify_generated_in_memory_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_save(
            path,
            tool_report,
        )
    )
...
def verify_generated_in_memory_full_calc_multi_sheet_retry_path_equivalent_reopen_modify_post_noop_reopen_modify_noop_save(
    path: Path,
    tool_report: dict[str, Any],
) -> tuple[dict[str, Any], dict[str, Any]]:
    label = (
        "generated in-memory full-calc multi-sheet path-equivalent retry "
        "reopen modify post-noop fresh-reopen modify no-op save"
    )
    zip_report, openpyxl_report = (
        verify_generated_in_memory_full_calc_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_save(
            path,
            tool_report,
        )
    )
...
def verify_generated_in_memory_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_save(
    path: Path,
    tool_report: dict[str, Any],
) -> tuple[dict[str, Any], dict[str, Any]]:
    label = (
        "generated in-memory multi-sheet retry reopen modify post-noop "
        "fresh-reopen modify no-op fresh-reopen modify save"
    )
    zip_report, openpyxl_report = (
        verify_generated_in_memory_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_save(
            path,
    ...
    mutations = tool_report.get("mutations", [])
    require("eighth:open(final-reopen-noop-output)" in mutations,
            f"{label}: tool did not report the final no-op fresh reopen stage")
    require("eighth:worksheet(Data).set_cell(G1,text)" in mutations,
            f"{label}: tool did not report the final no-op Data edit")
    require("eighth:worksheet(Summary).set_cell(F1,formula)" in mutations,
            f"{label}: tool did not report the final no-op Summary edit")
    require("eighth:save_as(final-noop-reopen-output)" in mutations,
            f"{label}: tool did not report the final no-op reopen save stage")

    sheet_entries = zip_report["sheet_entries"]
    data_xml = read_zip_text(path, sheet_entries["Data"])
    require('r="G1"' in data_xml and "retry-reopened-final-noop-data" in data_xml,
            f"{label}: missing final no-op Data!G1 text")
    summary_formulas = worksheet_formula_cells(path, "Summary")
    require(summary_formulas.get("F1") == "Data!B1+40",
            f"{label}: Summary!F1 formula mismatch {summary_formulas!r}")
    ...
    try:
        data = workbook["Data"]
        summary = workbook["Summary"]
        require(data["G1"].value == "retry-reopened-final-noop-data",
                f"{label}: Data!G1 mismatch")
        require(summary["F1"].value == "=Data!B1+40",
                f"{label}: Summary!F1 mismatch {summary['F1'].value!r}")
        openpyxl_report["Data!G1"] = data["G1"].value
        openpyxl_report["Summary!F1"] = summary["F1"].value
    finally:
        workbook.close()

    zip_report["summary_formulas"] = summary_formulas
    zip_report["final_noop_reopen_modify_save"] = "checked"
    return zip_report, openpyxl_report


def verify_generated_in_memory_full_calc_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_save(
    path: Path,
    tool_report: dict[str, Any],
) -> tuple[dict[str, Any], dict[str, Any]]:
    label = (
        "generated in-memory full-calc multi-sheet retry reopen modify "
        "post-noop fresh-reopen modify no-op fresh-reopen modify save"
    )
    zip_report, openpyxl_report = (
        verify_generated_in_memory_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_save(
            path,
            tool_report,
        )
    )
...
def verify_generated_in_memory_full_calc_multi_sheet_retry_path_equivalent_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_save(
    path: Path,
    tool_report: dict[str, Any],
) -> tuple[dict[str, Any], dict[str, Any]]:
    label = (
        "generated in-memory full-calc multi-sheet path-equivalent retry "
        "reopen modify post-noop fresh-reopen modify no-op fresh-reopen modify save"
    )
    zip_report, openpyxl_report = (
        verify_generated_in_memory_full_calc_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_save(
            path,
            tool_report,
        )
    )
...
def verify_generated_in_memory_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_noop_save(
    path: Path,
    tool_report: dict[str, Any],
) -> tuple[dict[str, Any], dict[str, Any]]:
    label = (
        "generated in-memory multi-sheet retry reopen modify post-noop "
        "fresh-reopen modify no-op fresh-reopen modify no-op save"
    )
    zip_report, openpyxl_report = (
        verify_generated_in_memory_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_save(
            path,
    ...
    require("ninth:save_as(final-noop-reopen-noop-output)" in tool_report.get("mutations", []),
            f"{label}: tool did not report the final no-op reopen no-op save stage")
    zip_report["final_noop_reopen_modify_noop_save"] = "byte-identical"
    return zip_report, openpyxl_report


def verify_generated_in_memory_full_calc_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_noop_save(
    path: Path,
    tool_report: dict[str, Any],
) -> tuple[dict[str, Any], dict[str, Any]]:
    label = (
        "generated in-memory full-calc multi-sheet retry reopen modify "
        "post-noop fresh-reopen modify no-op fresh-reopen modify no-op save"
    )
    zip_report, openpyxl_report = (
        verify_generated_in_memory_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_noop_save(
            path,
            tool_report,
        )
    )
...
def verify_generated_in_memory_full_calc_multi_sheet_retry_path_equivalent_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_noop_save(
    path: Path,
    tool_report: dict[str, Any],
) -> tuple[dict[str, Any], dict[str, Any]]:
    label = (
        "generated in-memory full-calc multi-sheet path-equivalent retry "
        "reopen modify post-noop fresh-reopen modify no-op fresh-reopen modify no-op save"
    )
    zip_report, openpyxl_report = (
        verify_generated_in_memory_full_calc_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_noop_save(
            path,
            tool_report,
        )
    )
...
def verify_generated_in_memory_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_noop_reopen_modify_save(
    path: Path,
    tool_report: dict[str, Any],
) -> tuple[dict[str, Any], dict[str, Any]]:
    label = (
        "generated in-memory multi-sheet retry reopen modify post-noop "
        "fresh-reopen modify no-op fresh-reopen modify no-op fresh-reopen modify save"
    )
    zip_report, openpyxl_report = (
        verify_generated_in_memory_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_noop_save(
            path,
    ...
    mutations = tool_report.get("mutations", [])
    require("tenth:open(final-noop-reopen-noop-output)" in mutations,
            f"{label}: tool did not report the final no-op no-op fresh reopen stage")
    require("tenth:worksheet(Data).set_cell(H1,text)" in mutations,
            f"{label}: tool did not report the final no-op no-op Data edit")
    require("tenth:worksheet(Summary).set_cell(G1,formula)" in mutations,
            f"{label}: tool did not report the final no-op no-op Summary edit")
    require("tenth:save_as(final-noop-reopen-noop-reopen-output)" in mutations,
            f"{label}: tool did not report the final no-op no-op reopen save stage")

    sheet_entries = zip_report["sheet_entries"]
    data_xml = read_zip_text(path, sheet_entries["Data"])
    require('r="H1"' in data_xml and "retry-reopened-final-noop-noop-data" in data_xml,
            f"{label}: missing final no-op no-op Data!H1 text")
    summary_formulas = worksheet_formula_cells(path, "Summary")
    require(summary_formulas.get("G1") == "Data!B1+50",
            f"{label}: Summary!G1 formula mismatch {summary_formulas!r}")
    ...
    try:
        data = workbook["Data"]
        summary = workbook["Summary"]
        require(data["H1"].value == "retry-reopened-final-noop-noop-data",
                f"{label}: Data!H1 mismatch")
        require(summary["G1"].value == "=Data!B1+50",
                f"{label}: Summary!G1 mismatch {summary['G1'].value!r}")
        openpyxl_report["Data!H1"] = data["H1"].value
        openpyxl_report["Summary!G1"] = summary["G1"].value
    finally:
        workbook.close()

    zip_report["summary_formulas"] = summary_formulas
    zip_report["final_noop_reopen_noop_reopen_modify_save"] = "checked"
    return zip_report, openpyxl_report


def verify_generated_in_memory_full_calc_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_noop_reopen_modify_save(
    path: Path,
    tool_report: dict[str, Any],
) -> tuple[dict[str, Any], dict[str, Any]]:
    label = (
        "generated in-memory full-calc multi-sheet retry reopen modify "
        "post-noop fresh-reopen modify no-op fresh-reopen modify no-op fresh-reopen modify save"
    )
    zip_report, openpyxl_report = (
...
def verify_generated_in_memory_full_calc_multi_sheet_retry_path_equivalent_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_noop_reopen_modify_save(
    path: Path,
    tool_report: dict[str, Any],
) -> tuple[dict[str, Any], dict[str, Any]]:
    label = (
        "generated in-memory full-calc multi-sheet path-equivalent retry "
        "reopen modify post-noop fresh-reopen modify no-op fresh-reopen modify no-op fresh-reopen modify save"
    )
    zip_report, openpyxl_report = (
        verify_generated_in_memory_full_calc_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_noop_reopen_modify_save(
            path,
            tool_report,
        )
    )
...
def verify_generated_image_replace_noop_save(
    path: Path,
    replacement_image: Path,
    tool_report: dict[str, Any],
) -> tuple[dict[str, Any], dict[str, Any]]:
    zip_report, openpyxl_report = verify_generated_image_replace(path, replacement_image)
    require("save_as(noop-output)" in tool_report.get("mutations", []),
            "generated image replace no-op save: tool did not report the no-op save stage")
    zip_report["noop_save"] = "byte-identical"
    return zip_report, openpyxl_report
...
def run_generated_case(
    ...
    elif scenario == "generated_in_memory_full_calc_delete_column_formula":
        zip_xml, openpyxl_report = verify_generated_in_memory_full_calc_delete_column_formula(
            output_path,
            tool_report,
        )
    elif scenario == "generated_in_memory_full_calc_delete_column_formula_noop_save":
        zip_xml, openpyxl_report = (
            verify_generated_in_memory_full_calc_delete_column_formula_noop_save(
                output_path,
                tool_report,
            )
        )
    ...
    elif scenario == "generated_in_memory_full_calc_insert_column_formula":
        zip_xml, openpyxl_report = verify_generated_in_memory_full_calc_insert_column_formula(
            output_path,
            tool_report,
        )
    elif scenario == "generated_in_memory_full_calc_insert_column_formula_noop_save":
        zip_xml, openpyxl_report = (
            verify_generated_in_memory_full_calc_insert_column_formula_noop_save(
                output_path,
                tool_report,
            )
        )
    ...
    elif scenario == "generated_in_memory_full_calc_delete_row_formula":
        zip_xml, openpyxl_report = verify_generated_in_memory_full_calc_delete_row_formula(
            output_path,
            tool_report,
        )
    elif scenario == "generated_in_memory_full_calc_delete_row_formula_noop_save":
        zip_xml, openpyxl_report = verify_generated_in_memory_full_calc_delete_row_formula_noop_save(
            output_path,
            tool_report,
        )
    ...
    elif scenario == "generated_in_memory_full_calc_retry_reopen_modify_noop_save":
        zip_xml, openpyxl_report = (
            verify_generated_in_memory_full_calc_retry_reopen_modify_noop_save(
                output_path,
                tool_report,
            )
        )
    elif scenario == "generated_in_memory_full_calc_retry_path_equivalent_reopen_modify_noop_save":
        zip_xml, openpyxl_report = (
            verify_generated_in_memory_full_calc_retry_path_equivalent_reopen_modify_noop_save(
                output_path,
                tool_report,
            )
        )
    elif scenario == "generated_in_memory_full_calc_retry_path_equivalent_reopen_modify_post_noop_third_save":
        zip_xml, openpyxl_report = (
            verify_generated_in_memory_full_calc_retry_path_equivalent_reopen_modify_post_noop_third_save(
                output_path,
                tool_report,
            )
        )
    elif scenario == "generated_in_memory_full_calc_retry_reopen_modify_post_noop_third_save":
        zip_xml, openpyxl_report = (
            verify_generated_in_memory_full_calc_retry_reopen_modify_post_noop_third_save(
                output_path,
                tool_report,
            )
        )
    ...
    elif scenario == "generated_in_memory_full_calc_multi_sheet_retry_reopen_modify_noop_save":
        zip_xml, openpyxl_report = (
            verify_generated_in_memory_full_calc_multi_sheet_retry_reopen_modify_noop_save(
                output_path,
                tool_report,
            )
        )
    elif scenario == "generated_in_memory_full_calc_multi_sheet_retry_path_equivalent_reopen_modify_noop_save":
        zip_xml, openpyxl_report = (
            verify_generated_in_memory_full_calc_multi_sheet_retry_path_equivalent_reopen_modify_noop_save(
                output_path,
                tool_report,
            )
        )
    elif scenario == "generated_in_memory_full_calc_multi_sheet_retry_reopen_modify_post_noop_third_save":
        zip_xml, openpyxl_report = (
            verify_generated_in_memory_full_calc_multi_sheet_retry_reopen_modify_post_noop_third_save(
                output_path,
                tool_report,
            )
        )
    ...
    elif scenario == "generated_in_memory_full_calc_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_save":
        zip_xml, openpyxl_report = (
            verify_generated_in_memory_full_calc_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_save(
                output_path,
                tool_report,
    ...
    elif scenario == "generated_in_memory_full_calc_multi_sheet_retry_path_equivalent_reopen_modify_post_noop_reopen_modify_noop_save":
        zip_xml, openpyxl_report = (
            verify_generated_in_memory_full_calc_multi_sheet_retry_path_equivalent_reopen_modify_post_noop_reopen_modify_noop_save(
                output_path,
                tool_report,
            )
        )
    elif scenario == "generated_in_memory_full_calc_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_save":
        zip_xml, openpyxl_report = (
            verify_generated_in_memory_full_calc_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_save(
                output_path,
                tool_report,
    ...
    elif scenario == "generated_in_memory_full_calc_multi_sheet_retry_path_equivalent_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_save":
        zip_xml, openpyxl_report = (
            verify_generated_in_memory_full_calc_multi_sheet_retry_path_equivalent_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_save(
                output_path,
                tool_report,
            )
        )
    elif scenario == "generated_in_memory_full_calc_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_noop_save":
        zip_xml, openpyxl_report = (
            verify_generated_in_memory_full_calc_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_noop_save(
                output_path,
                tool_report,
    ...
    elif scenario == "generated_in_memory_full_calc_multi_sheet_retry_path_equivalent_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_noop_save":
        zip_xml, openpyxl_report = (
            verify_generated_in_memory_full_calc_multi_sheet_retry_path_equivalent_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_noop_save(
                output_path,
                tool_report,
            )
        )
    elif scenario == "generated_in_memory_full_calc_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_noop_reopen_modify_save":
        zip_xml, openpyxl_report = (
            verify_generated_in_memory_full_calc_multi_sheet_retry_reopen_modify_post_noop_reopen_modify_noop_reopen_modify_noop_reopen_modify_save(
                output_path,
                tool_report,
    ...
    elif scenario == "generated_image_replace_noop_save":
        require(replacement_image is not None,
                "generated image replace no-op save: missing replacement image in tool report")
        zip_xml, openpyxl_report = verify_generated_image_replace_noop_save(
            output_path,
            replacement_image,
            tool_report,
        )
