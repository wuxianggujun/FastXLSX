...
description: "实现或审查 FastXLSX Phase 1 最小可写 XLSX。用于 workbook、worksheet、content types、relationships、基础 sheetData、数字/字符串/布尔单元格、ZIP package 输出、规划中的 minizip-ng/zlib-ng 接入审查、小型 XML part 生成、本机 Excel 可视化验证和参考文件拆包 XML 对比。"
---
...
- `minizip-ng` / `zlib-ng` production ZIP backend。
