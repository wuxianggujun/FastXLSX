...
void test_public_worksheet_editor_a1_overloads_read_mutate_and_save()
{
    ...
    check_reopened_clean_sheet_output(output, "Data", "A1 overload save",
        [](fastxlsx::WorksheetEditor& reopened_sheet) {
            check(reopened_sheet.cell_count() == 3,
                "A1 overload reopened output should keep sparse count");
            check_cell_range_equals(reopened_sheet.used_range(), 1, 1, 4, 4,
                "A1 overload reopened output should expose dirty-session bounds");
            const fastxlsx::CellValue reopened_a1 = reopened_sheet.get_cell("A1");
            check(reopened_a1.kind() == fastxlsx::CellValueKind::Text &&
                    reopened_a1.text_value() == "placeholder-a1",
                "A1 overload reopened output should keep source-backed A1");
            const fastxlsx::CellValue reopened_b1 = reopened_sheet.get_cell("B1");
            check(reopened_b1.kind() == fastxlsx::CellValueKind::Number &&
                    reopened_b1.number_value() == 1.0,
                "A1 overload reopened output should keep source-backed B1");
            check(!reopened_sheet.try_cell("A2").has_value(),
                "A1 overload reopened output should keep erased A2 absent");
            const fastxlsx::CellValue reopened_d4 = reopened_sheet.get_cell("D4");
...
void test_public_worksheet_editor_sparse_cells_range_snapshot()
{
    ...
    check_reopened_clean_sheet_output(output, "Data", "sparse_cells range snapshot",
        [](fastxlsx::WorksheetEditor& reopened_sheet) {
            ...
            check(reopened_a1.kind() == fastxlsx::CellValueKind::Text &&
                    reopened_a1.text_value() == "placeholder-a1",
                "range sparse_cells reopened output should keep source-backed A1");
            const fastxlsx::CellValue reopened_b1 = reopened_sheet.get_cell("B1");
            check(reopened_b1.kind() == fastxlsx::CellValueKind::Number &&
                    reopened_b1.number_value() == 2.0,
                "range sparse_cells reopened output should read post-snapshot B1 edit");
            check(!reopened_sheet.try_cell("A2").has_value(),
                "range sparse_cells reopened output should keep erased A2 absent");
            const fastxlsx::CellValue reopened_b3 = reopened_sheet.get_cell("B3");
            check(reopened_b3.kind() == fastxlsx::CellValueKind::Blank,
                "range sparse_cells reopened output should read explicit B3 blank");
            const fastxlsx::CellValue reopened_c3 = reopened_sheet.get_cell("C3");
            check(reopened_c3.kind() == fastxlsx::CellValueKind::Text &&
                    reopened_c3.text_value() == "range-new",
                "range sparse_cells reopened output should read in-range C3 text");
            const fastxlsx::CellValue reopened_d4 = reopened_sheet.get_cell("D4");
            check(reopened_d4.kind() == fastxlsx::CellValueKind::Text &&
                    reopened_d4.text_value() == "range-excluded",
                "range sparse_cells reopened output should keep outside D4 text");
        });
}
...
void test_public_worksheet_editor_row_and_column_cells_snapshot()
{
    ...
    check_reopened_clean_sheet_output(output, "Data", "row and column snapshot",
        [](fastxlsx::WorksheetEditor& reopened_sheet) {
            check(reopened_sheet.cell_count() == 6,
                "row/column snapshot reopened output should keep sparse count");
            check_cell_range_equals(reopened_sheet.used_range(), 1, 1, 4, 4,
                "row/column snapshot reopened output should expose dirty-session bounds");
            const std::vector<fastxlsx::WorksheetCellSnapshot> reopened_row_one =
                reopened_sheet.row_cells(1);
            check(reopened_row_one.size() == 3,
                "row/column snapshot reopened row_cells should keep row-one sparse count");
            check(reopened_row_one[0].reference.row == 1 && reopened_row_one[0].reference.column == 1 &&
                ...
                "row/column snapshot reopened row_cells should read post-snapshot A1 edit");
            check(reopened_row_one[1].reference.row == 1 && reopened_row_one[1].reference.column == 2 &&
                ...
                "row/column snapshot reopened row_cells should keep source-backed B1");
            check(reopened_row_one[2].reference.row == 1 && reopened_row_one[2].reference.column == 3 &&
                ...
                "row/column snapshot reopened row_cells should read explicit C1 blank");
            ...
            check(reopened_column_one.size() == 3,
                "row/column snapshot reopened column_cells should keep column-one sparse count");
            check(reopened_column_one[0].reference.row == 1 &&
                ...
                "row/column snapshot reopened column_cells should read edited A1 first");
            check(reopened_column_one[1].reference.row == 2 &&
                ...
                "row/column snapshot reopened column_cells should keep source-backed A2");
            check(reopened_column_one[2].reference.row == 3 &&
                ...
                "row/column snapshot reopened column_cells should keep edited A3");
            const fastxlsx::CellValue reopened_d4 = reopened_sheet.get_cell("D4");
            check(reopened_d4.kind() == fastxlsx::CellValueKind::Text &&
                    reopened_d4.text_value() == "outside-row-column",
                "row/column snapshot reopened output should keep outside D4 text");
        });
}
...
void test_public_worksheet_editor_erase_cells_range_reacquires_saved_state()
{
    ...
    check_reopened_clean_sheet_output(first_output, "Data", "range erase first save",
        [](fastxlsx::WorksheetEditor& reopened_sheet) {
            check(reopened_sheet.cell_count() == 0,
                "range erase first save reopened output should stay empty");
            check(!reopened_sheet.used_range().has_value(),
                "range erase first save reopened output should expose no sparse bounds");
            check(!reopened_sheet.try_cell("A1").has_value(),
                "range erase first save reopened output should keep erased A1 absent");
            check(!reopened_sheet.try_cell("B1").has_value(),
                "range erase first save reopened output should keep erased B1 absent");
            check(!reopened_sheet.try_cell("A2").has_value(),
                "range erase first save reopened output should keep erased A2 absent");
        });
    ...
    check_reopened_clean_sheet_output(second_output, "Data", "range erase reacquired save",
        [](fastxlsx::WorksheetEditor& reopened_sheet) {
            check(reopened_sheet.cell_count() == 1,
                "range erase reacquired save reopened output should contain one sparse cell");
            check_cell_range_equals(reopened_sheet.used_range(), 3, 3, 3, 3,
                "range erase reacquired save reopened output should expose C3 bounds");
            check(!reopened_sheet.try_cell("A1").has_value(),
                "range erase reacquired save reopened output should keep erased A1 absent");
            check(!reopened_sheet.try_cell("B1").has_value(),
                "range erase reacquired save reopened output should keep erased B1 absent");
            check(!reopened_sheet.try_cell("A2").has_value(),
                "range erase reacquired save reopened output should keep erased A2 absent");
            const fastxlsx::CellValue reopened_c3 = reopened_sheet.get_cell("C3");
            check(reopened_c3.kind() == fastxlsx::CellValueKind::Text &&
...
void test_public_worksheet_editor_shift_after_rename_formula_reacquire_reuses_styled_session()
{
    ...
    check(shifted_formula.has_value() &&
            shifted_formula->kind() == fastxlsx::CellValueKind::Formula &&
            shifted_formula->text_value() == "B3+C3" &&
            shifted_formula->has_style() &&
            shifted_formula->style_id().value() == styled_formula_style.value(),
...
void test_public_worksheet_editor_shift_after_rename_formula_option_mismatch_preserves_styled_session()
{
    ...
    check(saved_formula.has_value() &&
            ...
            saved_formula->text_value() == "A3+B3" &&
    ...
    check(reacquired_formula.has_value() &&
            ...
            reacquired_formula->text_value() == "A3+B3" &&
...
void test_public_worksheet_editor_shift_after_rename_formula_invalid_mutations_preserve_styled_session()
{
    ...
    check(preserved_formula.has_value() &&
            ...
            preserved_formula->text_value() == "A3+B3" &&
...
void test_public_worksheet_editor_shift_after_rename_formula_snapshot_reads_preserve_styled_session()
{
    ...
    check(all_cells[5].reference.row == 4 && all_cells[5].reference.column == 4 &&
            ...
            all_cells[5].value.text_value() == "A3+B3" &&
    ...
    check(shifted_range[3].reference.row == 4 && shifted_range[3].reference.column == 4 &&
            ...
            shifted_range[3].value.text_value() == "A3+B3" &&
    ...
    check(row_four[3].reference.row == 4 && row_four[3].reference.column == 4 &&
            ...
            row_four[3].value.text_value() == "A3+B3" &&
    ...
    check(column_four[0].reference.row == 4 &&
            ...
            column_four[0].value.text_value() == "A3+B3" &&
    ...
    check(requested_cells[0].reference.row == 4 && requested_cells[0].reference.column == 4 &&
            ...
            requested_cells[0].value.text_value() == "A3+B3" &&
    ...
    check(requested_cells[3].reference.row == 4 && requested_cells[3].reference.column == 4 &&
            ...
            requested_cells[3].value.text_value() == "A3+B3" &&
    ...
    check(reopened_row_four[3].reference.row == 4 && reopened_row_four[3].reference.column == 5 &&
            ...
            reopened_row_four[3].value.text_value() == "B3+C3" &&
    ...
    check(reopened_column_five.size() == 1 &&
            ...
            reopened_column_five[0].value.text_value() == "B3+C3" &&
