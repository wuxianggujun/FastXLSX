...
- **Ignored metadata:** source sharedStrings and source inline rich text ignore
  ...
  tokens missing the `?>` terminator, lacking a non-empty target, or starting
  with an obviously invalid ASCII name-start character are rejected instead of
