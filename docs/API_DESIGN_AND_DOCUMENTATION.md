...
- **Strict failure groups:** non-default or malformed source styles,
  ...
  unsupported value-wrapper shapes, cell-internal comments / processing
  instructions / CDATA, DOCTYPE-like, or other unsupported markup,
  malformed sharedStrings structures,
