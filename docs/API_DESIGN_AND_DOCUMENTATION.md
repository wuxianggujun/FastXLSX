...
- **Strict failure groups:** non-default or malformed source styles,
  ...
  unsupported value-wrapper shapes, non-whitespace direct sheetData text outside
