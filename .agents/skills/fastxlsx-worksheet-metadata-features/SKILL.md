...
- Table read 另测 owning range/name/displayName/basic columns/table-local filter、source order、absent container、callback retry、stored/DEFLATE、XML/nesting/table/id/target/name/column/range guardrail、tableParts count/direct child/QName/relationship namespace/schema、relationship missing/type/mode/target/part/content type、table root/header/filter/style diagnostics、totals/formula/full-filter rejection、foreign extension disambiguation和 package no-side-effect。
