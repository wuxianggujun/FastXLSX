...
- **Ignored metadata:** source sharedStrings and source inline rich text ignore
  ...
  an obviously invalid ASCII name-start character, or lacking whitespace /
  immediate `?>` after the target are rejected instead of being guessed or
  skipped.
