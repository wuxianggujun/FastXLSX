...
| 对象族 | 当前证据 | 允许表述 | 禁止表述 |
| --- | --- | --- | --- |
| Core/app/custom docProps | copy/rewrite 与 package side effect 测试 | 支持窄 document properties edit | 完整自定义属性对象模型 |
...
新增对象族或 mutation 时，先在 [TASK_BREAKDOWN.md](TASK_BREAKDOWN.md) 的 C2/C3 记录：
