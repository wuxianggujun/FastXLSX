...
// Common helpers for PackageEditor preservation-removal tests.
...
bool is_package_editor_shard(std::string_view shard)
{
    return shard == "all" || shard == "preservation-removal"
        || shard == "preservation-removal-policy"
        || shard == "preservation-removal-workbook-parts"
        || shard == "preservation-removal-drawing-parts";
}
